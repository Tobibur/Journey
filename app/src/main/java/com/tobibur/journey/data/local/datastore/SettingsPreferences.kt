...
class SettingsPreferences @Inject constructor(
    ...
    val accentColorFlow: Flow<Int> = context.dataStore.data
    ...
    suspend fun setAccentColor(colorInt: Int) {
        context.dataStore.edit { prefs -> prefs[ACCENT_COLOR] = colorInt }
    }

    suspend fun setUseDynamicColor(enabled: Boolean) {
        context.dataStore.edit { prefs -> prefs[USE_DYNAMIC_COLOR] = enabled }
    }
